...
from tests.evals.round2_cohorts import ADDITIONAL_COHORT, HEURISTIC_COHORT, REFERENCE_EXACT_COHORT, validate_reference_exact_cohort
...
COHORTS: dict[str, tuple[str, ...]] = {
    "heuristic_9": HEURISTIC_COHORT,
    "reference_exact_9": REFERENCE_EXACT_COHORT,
    "additional_21": ADDITIONAL_COHORT,
}
...
def main() -> None:
    ...
    parser.add_argument("--output-json", default="tests/evals/round2_baseline.json")
    parser.add_argument("--output-md", default="tests/evals/round2_baseline.md")
    args = parser.parse_args()

    missing_reference = validate_reference_exact_cohort()
    if missing_reference:
        raise RuntimeError(f"Reference exact cohort contains non-canonical tickers: {missing_reference}")
